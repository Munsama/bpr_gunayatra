...
<title>Admin BPR Guna Yatra - Edit Good Corporate Governance</title>
@endsection
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit Good Corporate Governance</h6>
        </div>
        <div class="card-body">
            <form action="{{route('update_gcg')}}" method="post" id="sample_form" class="form-horizontal"
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div align="center">
                            ...
                            <div>
                            <canvas id="pdfViewer" src="{{asset('storage/good_corporate_governance').('/').($data->dokumen)}}" style="width:100%; height:100%;" ></canvas>
                            </div>
                    ...
                    <div class="col-lg-8">
                        <div align="center">
                            ...
                            <div>
                                <img id="showgambar" src="{{asset('storage/good_corporate_governance').('/').($data->gambar)}}" class="img-fluid"
