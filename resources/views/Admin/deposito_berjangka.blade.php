...
@section ('head')
    <title>Admin BPR Guna Yatra - Deposito Berjangka </title>
...
@section ('konten')
    ...
    <div class="container-fluid">
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Simpanan Deposito Berjangka</h1>
        <p class="mb-4">Halaman ini berisi data calon nasabah yang mengajukan pembukaan rekening deposito. 
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
             <h6 class="m-0 font-weight-bold text-primary"> Data Pengajuan Deposito Berjangka</h6>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="deposito_table" width="100%">
                     <thead>
                      <tr>
                       <th> No </th>
                       <th> Nama</th>
...
$(document).ready(function(){
 ...
 $('#sample_form').on('submit', function(event){
  ...
  {
   $.ajax({
    url:"{{ route('crud_deposito.update') }}",
    method:"POST",
    ...
    success:function(data)
    {
     ...
     if(data.success)
     {
      ...
      $('#deposito_table').DataTable().ajax.reload();
     }
 ...
 $(document).on('click', '.delete', function(){
  deposito_id = $(this).attr('id');
  $('#confirmModal').modal('show');
 });

 $('#ok_button').click(function(){
  $.ajax({
   url:"crud_deposito/destroy/"+deposito_id,
   beforeSend:function(){
