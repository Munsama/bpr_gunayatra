...
<title>Admin BPR Guna Yatra - Tambah Annual Report</title>
@endsection
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Tambah Annual Report</h6>
        </div>
        <div class="card-body">
            <form action="{{route('store_ar')}}" method="post" id="sample_form" class="form-horizontal"
