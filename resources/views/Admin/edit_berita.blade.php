...
@section ('head')
    <title>Admin BPR Guna Yatra - Edit Berita</title>
@endsection
...
<a href="javascript:history.back()" data-toggle="tooltip"  data-id="'.$row->id.'" data-original-title="Back" class="  mb-3 btn btn-danger ">Back</a>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{route('update_brt')}}" method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-4 ">
                        <div align="center">
                            ...
                            <div>
                                <img id="showgambar" src="{{asset('images').('/').($data->foto)}}" class="img-fluid" style=" padding-top: 10px;  padding-bottom: 20px; width:70%; height:70%; ">
                            </div>
                            <div>    
                                <input type="file" name="foto" id="inputgambar" accept="image/jpg, image/png, image/jpeg"/>
                    ...
                    <div class="col-lg-8">
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                            <input required type="date" name="tanggal" id="tanggal" class="form-control" value="{{$data->tanggal}}" />
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-lg-12">    
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                            <textarea required name="deskripsi" id="deskripsi"  class="ckeditor form-control">{{$data->deskripsi}}</textarea>
                            </div>
                        </div>
