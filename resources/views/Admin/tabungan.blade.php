...
@section ('head')
    <title>Admin BPR Guna Yatra - Tabungan </title>
...
@section ('konten')
    ...
    <div class="container-fluid">
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Simpanan Tabungan</h1>
        <p class="mb-4">Halaman ini berisi data calon nasabah yang mengajukan pembukaan rekening tabungan. 
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
             <h6 class="m-0 font-weight-bold text-primary"> Data Pengajuan Tabungan</h6>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="tabungan_table" width="100%">
                     <thead>
                      <tr>
                       <th> No </th>
                       <th> Nama</th>
...
$(document).ready(function(){
    ...
    $('#sample_form').on('submit', function(event){
        ...
        if($('#action').val() == "Edit"){
            $.ajax({
            url:"{{ route('crud_tabungan.update') }}",
            method:"POST",
            ...
            success:function(data){
                ...
                if(data.success){
                    ...
                    $('#tabungan_table').DataTable().ajax.reload();
                }
 ...
 $(document).on('click', '.delete', function(){
  tabungan_id = $(this).attr('id');
  $('#confirmModal').modal('show');
 });

 $('#ok_button').click(function(){
  $.ajax({
   url:"crud_tabungan/destroy/"+tabungan_id,
   beforeSend:function(){
