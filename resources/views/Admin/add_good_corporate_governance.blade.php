...
<title>Admin BPR Guna Yatra - Tambah Good Corporate Governance</title>
@endsection
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Tambah Good Corporate Governance</h6>
        </div>
        <div class="card-body">
            <form action="{{route('store_gcg')}}" method="post" id="sample_form" class="form-horizontal"
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div align="center">
                            ...
                            <input required type="file" accept="application/pdf" name="dokumen" id="myPdf" />
                            <div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div align="center">
                            ...
                            <div>
                                <img id="showgambar" src="" class="img-fluid"
                                    style=" padding-top: 10px;  padding-bottom: 20px; width:50%; height:50%; ">
                            </div>
                            <input required type="file" accept="image/jpg, image/jpeg, image/png" name="gambar"
                                id="inputgambar" />
                            <div>
                            </div>
                        </div>
