...
@section('head')
	<title> BPR Guna Yatra - Kredit Multiguna</title>
	<!-- Bootstrap core CSS -->
...
<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link" href="#" id="navbarDropdownBlog" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Tentang Kami<i class="fas fa-sort-down"></i></a>
					...
					<li class="nav-item dropdown">
						<a class="nav-link active" href="#" id="navbarDropdownPortfolio" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pinjaman <i class="fas fa-sort-down"></i></a>
...
<div class="full-title">
		<div class="container">
			...
			<h1 class="mt-4 mb-3"> Kredit Multiguna </h1>
			<div class="breadcrumb-main">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Kredit Multiguna</li>
				</ol>
			</div>
		</div>
	</div>
    ...
    <div class="item-pro">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-8">
					<img class="img-fluid" src="{{asset('assets/images/multiguna.jpg')}}" alt="" />
				</div>
				<div class="col-md-4">
					<h3 class="my-3">Apa itu pinjaman multiguna?</h3>
					<p> Pinjaman multiguna merupakan  merupakan kredit untuk membiayai berbagai kebutuhan hidup Anda baik mulai dari primer hingga tersier dengan jaminan properti seperti rumah tinggal/rumah toko(ruko)/rumah kantor(rukan)/tanah kosong.</p>
					<h3 class="my-3">Pinjaman multiguna BPR Guna Yatra</h3>
					<p>Pinjaman multiguna di BPR Guna Yatra – Penuhi beragam kebutuhan seperti renovasi rumah, pengobatan, modal usaha, biaya pendidikan dan keluarga, serta biaya kebutuhan lainnya dengan cepat dan mudah.  </p>
					<button type="button" name="create_multiguna" id="create_multiguna" class="btn btn-success btn-sm">Ajukan Kredit Multiguna </button>	
				</div>
			</div>
			<br>
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<ul>
						...
						<li> 2)	Jangka waktu kredit 6 bulan hingga 10 tahun</li>
						<li> 3)	Plafon kredit hingga Rp 1 Milyar</li>
						<li> 4)	Presentase Pembiayaan (Loan to Value) hingga 60% dari nilai agunan berdasarkan penilaian bank </li>
						<li> 5)	Agunan:</li>
						<li> &nbsp;&nbsp;&nbsp; a. SHM (Sertifikat Hak Milik)/SHGB (Sertifikat Hak Guna Bangunan) untuk rumah, apartemen, ruko, rukan, atau tanah kosong untuk dibangun
						<li> &nbsp;&nbsp;&nbsp; b. BPKB Kendaraan (sebagai agunan tambahan)</li>
						<li> &nbsp;&nbsp;&nbsp; c. Bebas biaya appraisal untuk kredit plafon < Rp. 300 juta</li> 
						<li> 6)	Sistem pembayaran:</li>
						<li> &nbsp;&nbsp;&nbsp; a. Bayar bunga saat tanggal ulangan bulanan dan bayar pokok saat jatuh tempo</li>
						<li> &nbsp;&nbsp;&nbsp; b. Fasilitas pembayaran angsuran lewat autodebet </li> 
						<li> 7)	Fasilitas Take-over: Pengambilalihan KPR/kredit dari bank lain, dengan maksimum limit kredit sebesar outstanding (sisa pinjaman) terakhir di bank asal atau limit kredit baru sesuai perhitungan BPR Guna Yatra. Jika jumlahnya lebih besar dari outstanding terakhir di bank asal, Anda bisa memanfaatkannya untuk memenuhi berbagai kebutuhan lain.</li>
						<li> 8)	Fasilitas Top-up: Penambahan limit kredit yang telah berjalan di BPR Guna Yatra. Dengan tambahan limit kredit, Anda dapat memenuhi beragam kebutuhan lain</li>
				...
				<div class="col-lg-12">
					...
					<ul> 2) Calon Nasabah disarankan agar mempersiapkan kelengkapan dokumen penunjang guna memudahkan petugas kami saat melakukan penjemputan dokumen dan proses pengajuan kredit multiguna bisa segera dilakukan. </ul>
					<ul> Berikut daftar dokumen persyaratan kredit multiguna: </ul>
						...
						<table style="border-collapse: collapse; width: 90.6296%; height: 540px;" border="1">
							<tbody>
								...
								<tr style="height: 24px;">
									...
									<h6 style="font-family: Verdana, Arial, Helvetica, sans-serif; color: #333333; letter-spacing: 0.15px; text-align: center;">✓</h6>
									</td>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Formulir Pengajuan Modal Kerja </h4>
							...
							<div class="modal-body">
								...
								<form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											<input required type="text" name="nama" id="nama" class="form-control" placeholder="Masukkan Nama Lengkap Sesuai KTP" />
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-12" >Alamat </label>
										<div class="col-md-12">
											<input required type="text" name="alamat" id="alamat" class="form-control" placeholder="Masukkan Alamat Tempat Tinggal Anda" />
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-12" >No. Telepon </label>
										<div class="col-md-12">
											<input required type="tel" onkeypress="return event.charCode >= 48 && event.charCode <=57" name="telp" id="telp" class="form-control" placeholder="e.g: 081234567890" />
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-12" >Email </label>
										<div class="col-md-12">
											<input required type="email" name="email" id="email" class="form-control" placeholder="e.g: example@yourdomain.com" />
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-12" >Nominal Rencana Pinjam</label>
										<div class="col-md-12">
											<input required type="tel"  onkeypress="return event.charCode >= 48 && event.charCode <=57"
											name="nominal" id="nominal" class="form-control" placeholder="Masukkan Nominal Rencana Pinjaman " />
										</div>
									</div>
				...
				<div class="row">
					<div class="col-md-3 col-sm-6 mb-4">
						<a href="{{route('konsumsi')}}">
							<img class="img-fluid" src="{{asset('assets/images/konsumsi_related.jpg')}}" alt="" />
						<h5>Kredit Konsumsi</h5>
						</a>
					</div>
                    <div class="col-md-3 col-sm-6 mb-4">
	...
	<script type="text/javascript">
		$(function () {
			...
			$('#create_multiguna').click(function(){
				$('.modal-title').text("Form Pengajuan Kredit Multiguna");
				$('#sample_form')[0].reset();
			...
			$('#sample_form').on('submit', function(event){
				...
				if($('#action').val() == 'Kirim'){
					$.ajax({
						url:"{{ route('crud_multiguna.store') }}",
						method:"POST",
