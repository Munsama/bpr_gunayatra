...
@section('head')
<title> BPR Guna Yatra - Simpanan</title>
<!-- Bootstrap core CSS -->
...
<div class="full-title">
    <div class="container">
        ...
        <h1 class="mt-4 mb-3"> Simpanan </h1>
        ...
        <div class="row">
            <div class="col-lg-6 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <a class="hover-box" href="{{route('tabungan')}}">
                        <!-- <div class="dot-full">
								<i class="fas fa-link"></i>
							</div> -->
                        <img class="card-img-top" src="{{asset('assets/images/tabungan.jpg')}}" alt="" />
                    </a>
                    <div class="card-body">
                        <h4><a href="{{route('modal_kerja')}}">Tabungan</a></h4>
                        <p>Menabung dengan mudah, aman, dan bunga yang tinggi</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <a class="hover-box" href="{{route('deposito_berjangka')}}">
                        <!-- <div class="dot-full">
								<i class="fas fa-link"></i>
							</div> -->
                        <img class="card-img-top" src="{{asset('assets/images/deposito.jpg')}}" alt="" />
                    </a>
                    <div class="card-body">
                        <h4><a href="{{route('deposito_berjangka')}}">Deposito Berjangka</a></h4>
                        <p>Simpan dana lebih anda bersama kami dengan bunga deposito tinggi.</p>
                    </div>
                </div>
            </div>
