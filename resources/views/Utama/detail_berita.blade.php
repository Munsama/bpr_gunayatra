...
@section('head')
<title> BPR Guna Yatra - Detail Berita</title>
<!-- Bootstrap core CSS -->
...
<div class="full-title">
    <div class="container">
        ...
        <h1 class="mt-4 mb-3"> Detail Berita </h1>
    ...
    <div class="container">
        ...
        <div class="row">
            <div align="center" class="col-md-12">
                <img class="img-fluid" src="{{asset ('images').('/').($data->foto)}}" />
            </div>
        </div>
        <br>
        <div class="row">
            <div class="col-lg-12">
                <h2> {{$data->judul}}</h2>
                <p>{!!htmlspecialchars_decode($data->deskripsi)!!}</p>
            </div>
        </div>
        ...
        <div class="related-projects">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    <a href="berita/detail_berita/{{$d->id}}">
                        <img class="img-fluid" src="{{asset ('images').('/').($d->foto)}}" />
                        <h5>{{$d->judul}}</h5>
                    </a>
                </div>
                @endforeach
