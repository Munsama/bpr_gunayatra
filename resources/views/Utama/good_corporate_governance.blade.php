...
@section('head')
<title> BPR Guna Yatra - Good Corporate Governance </title>
<!-- Bootstrap core CSS -->
...
<div class="full-title">
    <div class="container">
        ...
        <h1 class="mt-4 mb-3"> Good Corporate Governance </h1>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 blog-entries">
                <!-- Blog Post -->
                <div class="card mb-4 ">
                    <img class="card-img-bottom" src="{{asset('storage/good_corporate_governance').('/').($d->gambar)}}" />
                    <div class="card-body">
                        <div align="center">
                        <h2 class="card-title">{{$d->judul}}</h2>
                        <a href="crud_good_corporate_governance/download_dokumen/{{$d->dokumen}}" class="btn btn-danger">Download</a>
                        </div>
                    </div>
                </div>
            </div>
