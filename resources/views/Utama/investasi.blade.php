...
@section('head')
<title> BPR Guna Yatra - Kredit Investasi</title>
<!-- Bootstrap core CSS -->
...
<div class="full-title">
    <div class="container">
        ...
        <h1 class="mt-4 mb-3"> Kredit Investasi </h1>
        <div class="breadcrumb-main">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Kredit Investasi</li>
            </ol>
        </div>
    </div>
</div>
...
<div class="item-pro">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                <img class="img-fluid" src="{{asset('assets/images/investasi.jpg')}}" alt="" />
            </div>
            <div class="col-md-4">
                <h3 class="my-3">Apa itu pinjaman investasi?</h3>
                <p> Pinjaman Investasi merupakan kredit yang digunakan untuk membiayai pembelian barang atau modal yang bersifat tetap (tidak habis dalam satu proses produksi, seperti tanah dan mesin-mesin)</p>
                <h3 class="my-3">Pinjaman Investasi BPR Guna Yatra</h3>
                <p>Pinjaman Investasi di BPR Guna Yatra – Manfaatkan kredit investasi dari BPR Guna Yatra untuk pembiayaan pembelian alat-alat produksi usaha, modernisasi mesin usaha Anda maupun sebagai modal perluasan dan pengembangan usaha baru. </p>
                <button type="button" name="create_investasi" id="create_investasi" class="btn btn-success btn-sm">Ajukan Kredit Investasi </button>
            </div>
        </div>
        <br>
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <ul>
                    ...
                    <li> 2) Jangka waktu kredit sampai dengan 15 tahun </li>
            ...
            <div class="col-lg-12">
                ...
                <ul> 2) Calon Nasabah disarankan agar mempersiapkan kelengkapan dokumen penunjang guna memudahkan
                    petugas kami saat melakukan penjemputan dokumen dan proses pengajuan kredit investasi bisa segera
                    dilakukan. </ul>
                <ul> Berikut daftar dokumen persyaratan kredit investasi: </ul>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Form Pengajuan Pinjaman Investasi</h4>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#create_investasi').click(function () {
            $('.modal-title').text("Form Pengajuan Pinjaman Investasi");
            $('#sample_form')[0].reset();
        ...
        $('#sample_form').on('submit', function (event) {
            ...
            if ($('#action').val() == 'Kirim') {
                $.ajax({
                    url: "{{ route('crud_investasi.store') }}",
                    method: "POST",
