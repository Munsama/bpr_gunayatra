...
@section('head')
<title> BPR Guna Yatra - Karir </title>
<!-- Bootstrap core CSS -->
        ...
        <div class="row">
            ...
            <div class="col-md-4 blog-entries">
                ...
                <div class="card mb-4 ">
                    <div class="card-body">
                        <div class="by-post">
                            Diposting tanggal {{\Carbon\Carbon::parse($d->tanggal)->format('d M Y')}}
                        </div>
                        <h2 class="card-title">{{$d->nama_pekerjaan}}</h2>
                        <ul> <i class="fas fa-tasks"></i> <strong>Kualifikasi: </strong>
                            <p class="card-text">{!!htmlspecialchars_decode($d->kualifikasi)!!}</p>
                        </ul>
                        <ul> <i class="fas fa-bullseye"></i> <strong> Objektif: </strong>
                            <p class="card-text">{!!htmlspecialchars_decode($d->objektif)!!}</p>
                        </ul>
                        <ul> <i class="far fa-smile-beam"></i> <strong> Keuntungan: </strong>
                            <p class="card-text">{!!htmlspecialchars_decode($d->keuntungan)!!}</p>
                        </ul>
                        <div align="center">
                            <a href="{{route('lamar_kerja')}}" class="btn btn-primary">Lamar</a>
                        </div>
                    </div>
                </div>
            </div>
