...
@section('head')
<title> BPR Guna Yatra - Annual Reports </title>
<!-- Bootstrap core CSS -->
...
<div class="full-title">
    <div class="container">
        ...
        <h1 class="mt-4 mb-3"> Annual Report </h1>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 blog-entries">
                <!-- Blog Post -->
                <div class="card mb-4 ">
                    <img class="card-img-bottom" src="{{asset('storage/annual_report').('/').($d->gambar)}}" />
                    <div class="card-body">
                        <div align="center">
                        <h2 class="card-title">{{$d->judul}}</h2>
                        <a href="crud_annual_report/download_dokumen/{{$d->dokumen}}" class="btn btn-danger">Download</a>
                        </div>
                    </div>
                </div>
            </div>
