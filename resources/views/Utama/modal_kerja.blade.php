...
@section('head')
<title> BPR Guna Yatra - Kredit Modal Kerja</title>
<!-- Bootstrap core CSS -->
...
<div class="full-title">
    <div class="container">
        ...
        <h1 class="mt-4 mb-3"> Kredit Modal Kerja </h1>
        <div class="breadcrumb-main">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Kredit Modal Kerja</li>
            </ol>
        </div>
    </div>
</div>
...
<div class="item-pro">
    <div class="container">
        <!-- Kredit Modal Kerja Row -->
        <div class="row">
            <div class="col-md-8">
                <img class="img-fluid" src="{{asset('assets/images/modal_kerja.jpeg')}}" alt="" />
            </div>
            <div class="col-md-4">
                <h3 class="my-3">Apa itu pinjaman modal kerja?</h3>
                <p> Pinjaman modal kerja merupakan fasilitas kredit yang diberikan kepada pelaku usaha,
                    baik UMKM (mikro, ritel komersial, dan menengah) maupun korporat, dalam rangka pembiayaan
                    terhadap modal kerja atau modal usaha.</p>
                <h3 class="my-3">Pinjaman modal kerja BPR Guna Yatra</h3>
                <p>Pinjaman modal kerja di BPR Guna Yatra – Manfaatkan kredit modal kerja untuk menunjang perkembangan
                    usaha Anda. Pinjaman modal kerja dengan sistem plafon yang memperhitungkan hanya pembayaran bunga
                    pinjaman setiap bulannya. </p>
                <button type="button" name="create_modal_kerja" id="create_modal_kerja"
                    class="btn btn-success btn-sm">Ajukan Kredit Modal Kerja </button>
            </div>
        </div>
        <br>
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <ul> 2) Calon Nasabah disarankan agar mempersiapkan kelengkapan dokumen penunjang guna memudahkan
                    petugas kami saat melakukan penjemputan dokumen dan proses pengajuan kredit modal kerja bisa segera
                    dilakukan. </ul>
                <ul> Berikut daftar dokumen persyaratan kredit modal kerja: </ul>
                    ...
                    <table style="border-collapse: collapse; width: 90.6296%; height: 540px;" border="1">
                        <tbody>
                            ...
                            <tr style="height: 31px;">
                                ...
                                <td style="width: 50.3811%; height: 31px;">
                                    <h6>Copy BPKB / SHM / SHGB / SHMSRS</h6>
                                </td>
                                <td style="width: 8.80512%; height: 31px;">
                                    <h6
                                        style="font-family: Verdana, Arial, Helvetica, sans-serif; color: #333333; letter-spacing: 0.15px; text-align: center;">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Formulir Pengajuan Kredit Modal Kerja </h4>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#create_modal_kerja').click(function () {
            $('.modal-title').text("Form Pengajuan Kredit Modal Kerja");
            $('#sample_form')[0].reset();
        ...
        $('#sample_form').on('submit', function (event) {
            ...
            if ($('#action').val() == 'Kirim') {
                $.ajax({
                    url: "{{ route('crud_modal_kerja.store') }}",
                    method: "POST",
